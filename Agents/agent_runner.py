...
async def agent_runner(user_query,prev_action):
    try:
        ...
        if action.error is not None:
            ...
            return {'final_result':final_result,'summary':action_taken}
        ...
        return {'final_result':final_result.message,'summary':action_taken}
